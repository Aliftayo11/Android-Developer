package id.ac.poliban.e020320046.calculatortest;
...
public class MainActivity extends AppCompatActivity {
    ...
    private Calculator046 mCalculator;
    ...
    public void onAdd(View view) {
        compute(Calculator046.Operator.ADD);
    }
    /**
     * OnClick method called when the subtract Button is pressed.
     */
    public void onSub(View view) {
        compute(Calculator046.Operator.SUB);
    }
    /**
    ...
    public void onDiv(View view) {
        try {
            compute(Calculator046.Operator.DIV);
    ...
    public void onMul(View view) {
        compute(Calculator046.Operator.MUL);
    }
    private void compute(Calculator046.Operator operator) {
        double operandOne;
        double operandTwo;
        try {
